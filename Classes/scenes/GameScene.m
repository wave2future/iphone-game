...
- (id) init {
	...
	[mg setPosition:cpv(240, 60)];
	[mg2 setPosition:cpv(240, 120)];
	[tallGuyHome setPosition:cpv(260, 240)];
	[self addChild:bg z:0 parallaxRatio:cpv(0.001, 0.01)];
	//[self addChild:mg2 z:2 parallaxRatio:cpv(0.05, 0.05)];
